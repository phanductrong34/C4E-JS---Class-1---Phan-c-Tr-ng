...
var nameAu = document.getElementById("nameAu");

function randomQuote(){
    let randomNumber = Math.floor(Math.random()*quoteArr.length);
    console.log(`print quote number ${randomNumber}`);
    console.log(quoteArr[randomNumber]);
    h1.innerHTML = "";
    console.log(h1);
    quote.innerHTML = quoteArr[randomNumber].quoteText;
    nameAu.innerHTML = quoteArr[randomNumber].quoteAuthor 
