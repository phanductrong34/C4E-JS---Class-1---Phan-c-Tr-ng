...
for (let x in product){
 ...
 let temp = Object.keys(product)
console.log(temp);

let a = ["name","brand","color","price"]
console.log(...a);
...
// var {subject: assignment,assignTo: worker,dueDate: deadline} = task;
// console.log(`${assignment}, ${worker}, ${deadline} `);
...
console.log("14.1 All job hits list below");
console.log(...jobData["hits"]);
console.log("*************");



console.log('14.2 Get the first job hits');
console.log(`    ${jobData["hits"][0]}`);
console.log("*************");



console.log('14.3 Get the Job Title of first job ')
console.log(`   ${jobData["hits"][0]["jobTitle"]}`);
console.log("*************");



console.log('14.4 Get the benefits of the first job hit ')
console.log(jobData["hits"][0]["benefits"]);
console.log("*************");



console.log('14.5 Log out first job hit benefit values');
for(let i = 0; i < jobData["hits"][0]["benefits"].length; i++){
    console.log(`    ${i+1}.${jobData["hits"][0]["benefits"][i]["benefitValue"]}`);
}
console.log("*************");



console.log(`14.6 Log out ​jobTitle​ and ​benefitValue​ of all job ​hits`);
for(let i = 0; i < jobData["hits"].length; i++){

    console.log(jobData["hits"][i].jobTitle);
    console.log('Benefits');
    for(let k = 0; k < jobData["hits"][i]["benefits"].length; k++){
        console.log(`- ${k+1}.${jobData["hits"][i]["benefits"][k]["benefitValue"]}`);
...
console.log(`14.7 Log out ​jobTitle​, ​locations​, ​skills​, ​jobSalary​ of all job ​hits`);
for(let i = 0; i < jobData["hits"].length; i++){
    console.log(`Title :${jobData["hits"][i].jobTitle}`);
    console.log(`Salary: ${jobData["hits"][i].salaryMax} $`);
    console.log('Location');
    for(let k = 0; k < jobData["hits"][i]["locationVIs"].length; k++){
        console.log(jobData["hits"][i]["locationVIs"][k]);
    }
    console.log('Benefits:');
    for(let k = 0; k < jobData["hits"][i]["benefits"].length; k++){
        console.log(`- ${k+1}.${jobData["hits"][i]["benefits"][k]["benefitValue"]}`);
    ...
    console.log("Skill :");
    for(let m = 0; m < jobData["hits"][i]["_highlightResult"]["skills"].length; m++){
        console.log(`- ${m+1}.${jobData["hits"][i]["_highlightResult"]["skills"][m]["value"]}`);
